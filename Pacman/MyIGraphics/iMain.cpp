...
void top()
{
    ...
    iText(620,800,"Pacman" , GLUT_BITMAP_TIMES_ROMAN_24);
    iText(615,700,"Welcome",GLUT_BITMAP_TIMES_ROMAN_24);
    iText(560,600,"Press 's' for Playing" ,GLUT_BITMAP_TIMES_ROMAN_24);
...
void iDraw()
{
    ...
    if(!gvar)
    {
        double trix[3],triy[3];
        top();
        iSetColor(255,255,0);
        iFilledCircle(100 , 500 ,100, 500);
        iSetColor(0,0,255);
        trix[0]=100 ;
        triy[0]=500 ;
        trix[1]=260 ;
...
void iSpecialKeyboard(unsigned char key)
{
    ...
    {
        if(!((pacman_y+25>=870)||
                ((pacman_x>=400-10&&pacman_x<=420+10)&&(pacman_y-30>=273-70))||
    ...
    if (key == GLUT_KEY_RIGHT)
    {
        ...
        if(!((pacman_x+30>200&&pacman_x+30<220)&&(pacman_y+30>0&&pacman_y-20<=600)||
                ((pacman_x+30>400&&
                  (pacman_x+30<420)&&(pacman_y+30>300&&pacman_y-20<900))||
